...
class TestUtils(TestBase):
    ...
    def test_is_standard_nd_weight(self):
        ...
        with mock.patch("vllm_ascend.utils.torch_npu.get_npu_format", return_value=utils.ACL_FORMAT_FRACTAL_ND):
            self.assertTrue(utils._is_standard_nd_weight(npu_weight))

        with mock.patch("vllm_ascend.utils.torch_npu.get_npu_format", return_value=utils.ACL_FORMAT_FRACTAL_NZ):
